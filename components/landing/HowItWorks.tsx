...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative isolate overflow-hidden border-t border-border flex min-h-[calc(100dvh-60px)] flex-col justify-center py-20 md:py-28">
