"use client";
// From reactbits.dev (LiquidEther), a three.js fluid sim. Local changes: never
// starts under prefers-reduced-motion, and WebGL setup is guarded so devices
// without a context render nothing instead of throwing.
// eslint-disable: upstream types its sim internals as any; retyping 40k chars
// of vendored code is not worth the regression risk.
...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // No static frame worth showing: bail before any GL work.
...
`;
    ...
    try {
      ...
      return; // no WebGL context on this device
    }
    if (!webgl) return;
